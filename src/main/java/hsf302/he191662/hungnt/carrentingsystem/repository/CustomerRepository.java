...
public interface CustomerRepository extends JpaRepository<Customer,Long> {
    ...
    @Query("select c from Customer c where (:customerId is null or lower(c.customerId) like concat('%', :customerId,'%')) and(:customerName is null or c.customerName = :customerName)")
